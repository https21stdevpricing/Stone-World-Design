...
export default function Home() {
  ...
  const categoryImages: Record<string, string> = {
    ...
    "sanitaryware": "/images/cat-marble.png", 
    "ceramic": "/images/cat-tiles.png", 
    "cement": "/images/cat-cement.png",
    "tmt bars": "/images/cat-cement.png", 
    "stone": "/images/cat-marble.png" 
  };
    ...
    <div className="min-h-screen flex flex-col bg-background font-sans">
      ...
      <section className="relative h-screen w-full overflow-hidden bg-black flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-20">
          ...
          >
            <h1 className="text-white text-6xl md:text-8xl lg:text-[96px] font-bold tracking-tight leading-tight mb-6">
            ...
            <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground rounded-full px-8 py-7 text-sm tracking-[0.2em] font-bold uppercase transition-all duration-300">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-border/40">
            <div className="space-y-2">
              ...
              <p className="text-xs tracking-widest text-muted-foreground uppercase font-bold">Years Legacy</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-5xl font-bold text-primary">10k+</h3>
              <p className="text-xs tracking-widest text-muted-foreground uppercase font-bold">Projects</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-5xl font-bold text-primary">50+</h3>
              <p className="text-xs tracking-widest text-muted-foreground uppercase font-bold">Premium Brands</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-5xl font-bold text-primary">All India</h3>
              <p className="text-xs tracking-widest text-muted-foreground uppercase font-bold">Delivery</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 bg-foreground text-background">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <motion.div
            ...
            className="space-y-8"
          >
            <h2 className="text-4xl md:text-6xl font-bold tracking-tight leading-snug">
            ...
            <p className="text-muted-foreground text-sm tracking-widest uppercase font-bold">AB Stone World Pvt. Ltd.</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-16">
            <div className="space-y-4">
              <h2 className="text-4xl font-bold tracking-tight text-foreground">Curated Categories</h2>
              <p className="text-muted-foreground tracking-wide font-medium">Materials sourced for uncompromising quality.</p>
            </div>
            <Button asChild variant="ghost" className="hidden md:flex hover:bg-transparent hover:text-primary tracking-widest uppercase text-xs font-bold">
                ...
                >
                  <Link href={`/discover?categoryId=${cat.id}`} className="group block relative aspect-[3/4] overflow-hidden bg-muted">
                    ...
                    <div className="absolute inset-x-0 bottom-0 p-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                      ...
                      <div className="w-0 h-[2px] bg-primary mt-4 transition-all duration-500 group-hover:w-full" />
                    </div>
                  </Link>
                </motion.div>
              );
        ...
        <section className="py-32 bg-muted/30 border-y border-border/40">
          <div className="container mx-auto px-4">
            <div className="text-center space-y-4 mb-16">
              <h2 className="text-4xl font-bold tracking-tight text-foreground">Featured Selection</h2>
              <p className="text-muted-foreground tracking-wide font-medium">Handpicked surfaces of extraordinary character.</p>
            </div>
                ...
                >
                  <Link href={`/discover/${product.id}`} className="group block">
                    ...
                    <div className="space-y-2 text-center">
                      <p className="text-xs tracking-widest text-muted-foreground uppercase font-bold">{product.categoryName}</p>
            ...
            <div className="mt-16 text-center">
              <Button asChild variant="outline" className="rounded-full px-8 py-6 text-xs tracking-widest uppercase border-foreground text-foreground hover:bg-foreground hover:text-background font-bold transition-all duration-300">
      ...
      {blogPosts.length > 0 && (
        <section className="py-32 bg-background">
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-end mb-16">
              <div className="space-y-4">
                <h2 className="text-4xl font-bold tracking-tight text-foreground">The Journal</h2>
                <p className="text-muted-foreground tracking-wide font-medium">Insights from the world of luxury materials.</p>
              </div>
              <Button asChild variant="ghost" className="hidden md:flex hover:bg-transparent hover:text-primary tracking-widest uppercase text-xs font-bold">
                ...
                >
                  <Link href={`/blog/${post.slug}`} className="group block">
                    ...
                    <div className="space-y-3">
                      <p className="text-xs text-muted-foreground font-mono font-bold uppercase">{format(new Date(post.createdAt), 'MMM dd, yyyy')}</p>
                      <h3 className="text-xl font-bold text-foreground group-hover:text-primary transition-colors leading-snug">{post.title}</h3>
                    </div>
                  </Link>
                </motion.div>
              ))}
      ...
      <section className="py-32 bg-primary relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-primary-foreground mb-8">Ready to define your space?</h2>
          <Button asChild size="lg" className="bg-background text-foreground hover:bg-white rounded-full px-10 py-7 text-sm tracking-[0.2em] font-bold uppercase transition-all duration-300">
